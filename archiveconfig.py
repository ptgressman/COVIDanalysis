...
#'archive' : 'archiveNYT/', 'checktimes' : [1,3], 'extension' : '.html'},
...
{ 'url' : 'https://en.wikipedia.org/wiki/COVID-19_pandemic_in_Pennsylvania',
'archive' : 'archiveOTHER/wikiPA', 'checktimes' : [1,3], 'extension' : '.html'},
